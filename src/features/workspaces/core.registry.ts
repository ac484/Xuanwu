 ...
 * It supports different component views for different contexts (e.g., single workspace vs. aggregated organization view).
 */
export interface CapabilityDetail {
  label: string;
  icon: ComponentType<any>;
  views: {
    single: CapabilityView; // View for a single workspace context
