...
function WorkspaceSettingsForm() {
    ...
    const [address, setAddress] = useState<Address>({ street: "", city: "", state: "", postalCode: "", country: "", description: "" });
    ...
    useEffect(() => {
      if (workspace) {
        ...
        setAddress(workspace.address || { street: "", city: "", state: "", postalCode: "", country: "", description: "" });
      }
    }, [workspace]);
    ...
    const onUpdateSettings = async () => {
      setLoading(true);
      try {
        await updateWorkspaceSettings({ name, visibility, lifecycleState, address });
